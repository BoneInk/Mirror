...
swiftc Sources/Mirror/Models.swift Sources/Mirror/NativeStyle.swift Sources/Mirror/LegacyBrandMigration.swift Sources/Mirror/AppLanguage.swift \
  ...
  Sources/Mirror/CodexMemory.swift Sources/Mirror/CodexThreadPicker.swift Sources/Mirror/CodexExistingThread.swift Sources/Mirror/CodexReference.swift Tools/CodexReferenceSmoke/main.swift \
