...
swiftc Sources/Mirror/Models.swift Sources/Mirror/NativeStyle.swift Sources/Mirror/LegacyBrandMigration.swift Sources/Mirror/AppLanguage.swift \
  ...
  Sources/Mirror/CodexThreadPicker.swift Sources/Mirror/CodexExistingThread.swift Sources/Mirror/CodexReference.swift Tools/CodexBubbleSmoke/main.swift -framework AppKit -framework WebKit -o "$OUTPUT_DIR/bubble-smoke"
